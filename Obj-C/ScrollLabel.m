...
{
    CGFloat width;          //ScrollLabel width
    CGFloat height;
...
@property (nonatomic, assign) ScrollLabelDirection direction;
...
- (void)beginScrollWithDirection:(ScrollLabelDirection)direction {
    ...
    if (_direction == ScrollLabelDirection_Top) {
        _bLabel.frame = CGRectMake(0, height, CGRectGetWidth(_bLabel.frame), height);
    }else if (_direction == ScrollLabelDirection_Bottom) {
        _bLabel.frame = CGRectMake(0, -height, CGRectGetWidth(_bLabel.frame), height);
    }else if (_direction == ScrollLabelDirection_Left) {
        _bLabel.frame = CGRectMake(CGRectGetMaxX(_aLabel.frame), 0, CGRectGetWidth(_bLabel.frame), height);
    }else if (_direction == ScrollLabelDirection_Right) {
        _bLabel.frame = CGRectMake(-CGRectGetMaxX(_aLabel.frame), 0, CGRectGetWidth(_bLabel.frame), height);
    }
    if (timer != nil) {
        [timer invalidate];
...
- (void)animationLabel {
    ...
    switch (_direction) {
        case ScrollLabelDirection_Top:
        {
            ...
            break;
        case ScrollLabelDirection_Bottom:
        {
            if (fabs(CGRectGetMinY(_aLabel.frame))>=height) {
                _aLabel.frame = CGRectMake(0, 0, CGRectGetWidth(_aLabel.frame), height);
                _bLabel.frame = CGRectMake(0, -height, CGRectGetWidth(_bLabel.frame), height);
            ...
            break;
        case ScrollLabelDirection_Left:
        {
            ...
            break;
        case ScrollLabelDirection_Right:
        {
            if (fabs(CGRectGetMinX(_aLabel.frame))>=CGRectGetWidth(_aLabel.frame)) {
                _aLabel.frame = CGRectMake(0, 0, CGRectGetWidth(_aLabel.frame), height);
                _bLabel.frame = CGRectMake(-CGRectGetMaxX(_aLabel.frame), 0, CGRectGetWidth(_bLabel.frame), height);
...
{
    if (self.direction == ScrollLabelDirection_Top || self.direction == ScrollLabelDirection_Bottom) {
    ...
    }else if (self.direction == ScrollLabelDirection_Left || self.direction == ScrollLabelDirection_Right) {
        [_aLabel sizeToFit];
        [_bLabel sizeToFit];
